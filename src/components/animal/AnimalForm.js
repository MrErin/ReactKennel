...
export default class AnimalForm extends Component {
    ...
    // validation, creates animal object, and invokes the function reference passed from parent component
            ...
            <React.Fragment>
                <form className="animalForm">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" required="true" className="form-control" onChange={this.handleFieldChange} id="breed" placeholder="Breed" />
                    </div>
                    <div className="form-group">
